...
exports.create = function create( options, callback ) {
	...
	app.get('/purge/:queue/:plugin/:key', purge.doPurge );
	app.get('/purge/:queue/:plugin/:key/:sheet', purge.doPurge );
	app.get('/purge/:queue/:plugin/:key', purge.respond );
	app.get('/purge/:queue/:plugin/:key/:sheet', purge.respond );

	app.get('/republish/:queue/:plugin/:key/', purge.doPurge );
	app.get('/republish/:queue/:plugin/:key/:sheet', purge.doPurge );
